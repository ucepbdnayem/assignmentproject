    ...
    return (
        <div className={homeStyle.homeContainer}>
            <div>
                ...
                <h1 className={homeStyle.heading}>Where does it come from?</h1>
                <p className={homeStyle.paragraph}>
